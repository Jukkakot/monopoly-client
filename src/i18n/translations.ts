...
const en: T = {
  ...
  botChat: {
    boughtProperty: [
      ...
      'Neighbouring lot — now they\'re a pair. 👫', 'Had to grab this one.',
      'Location, location, location. 📍', 'A fine addition to the portfolio. 💼',
    ],
    builtHotel: [
      ...
      'A grand hotel, done. 🏨', 'This square is now poison to the rest. ☠️',
    ...
    rentGloat: [
      ...
      'Thanks, just pay up. 😌', 'This account grows nicely.',
      'Tenants are the best. 🏦', 'Cha-ching! 🤑',
    ],
    rentPain: [
      ...
      'Well, there go my savings.', 'Need to recover from that fast.',
      'An expensive lesson. 📚', 'That really hit the wallet. 😖',
    ],
    jail: [
    ...
    banter: [
      ...
      'No rush, it\'s a long game.', 'Relaxed — I\'ve got this. 😎',
      'Let\'s see where the token lands.', 'Market\'s up, I\'m buying more. 📈',
    ],
    banterLead: [
      'I\'m leading — and I intend to keep it. 😎', 'Fattest wallet at the table. 💰',
      'Victory\'s in sight. 🏆', 'Nobody\'s catching me.',
      'My empire keeps growing. 🏰', 'The rest are playing for second. 😏',
      'This is easy. 😌', 'The rent keeps flowing, thanks all.',
      'I\'m holding the reins.', 'Soon the whole board is mine. 🗺️',
    ],
    banterTrail: [
      'I\'m not out of it yet. 💪', 'I\'ll turn this game around.',
      'One good deal and I\'m back.', 'Behind, but not giving up.',
      'I\'ll climb back up. 📈', 'Could use a bit of luck now... 🍀',
      'This isn\'t over.', 'A comeback\'s coming, believe me. 😤',
      'Have to play it safe now.', 'Just wait — I\'ll turn the tide. 🌬️',
    ],
    banterLow: [
      'My cash is dwindling worryingly... 😰', 'It\'s tight now, must save.',
      'Hope I don\'t land on anyone\'s hotel. 😬', 'Little money, lots of risk.',
      'One big rent and I\'m in trouble.', 'Might have to mortgage soon.',
      'My heart races every roll. 💓', 'Praying for small rents. 🙏',
      'Will I survive this lap?', 'A cash crisis is near... 😅',
    ],
    drewCard: [
